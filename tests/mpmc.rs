...
fn channel<T>(size: usize) -> (ResizingMpmcQueueSender<T>, ResizingMpmcQueueReceiver<T>) {
    mpmc_queue::new(9, size)
}

#[test]
fn bounds() {
    is_send::<ResizingMpmcQueueSender<i32>>();
    is_send::<ResizingMpmcQueueReceiver<i32>>();
}
