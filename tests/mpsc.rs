...
use locklessness::sync::mpsc_queue::{ResizingMpscQueueReceiver, ResizingMpscQueueSender};
...
#[test]
fn bounds() {
    is_send::<ResizingMpscQueueSender<i32>>();
    is_send::<ResizingMpscQueueReceiver<i32>>();
}
